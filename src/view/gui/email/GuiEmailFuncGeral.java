...
public class GuiEmailFuncGeral extends javax.swing.JFrame {
    
    private Clinica clinica;
    private ClinicaMail cm;

    public GuiEmailFuncGeral(Clinica clinica) {
    ...
    private void initComponents() {
        ...
        setTitle("Enviar mensagem para funcionarios gerais");
    ...
    private void btEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEnviarActionPerformed
        ArrayList<FuncionarioGeral> funcionarios = this.clinica.getFuncionariosGerais();
        ...
        for(FuncionarioGeral f: funcionarios){
