...
public class GuiEmailAtendente extends javax.swing.JFrame {
    
    private Clinica clinica;
    private ClinicaMail cm;

    public GuiEmailAtendente(Clinica clinica) {
    ...
    private void initComponents() {
        ...
        setTitle("Enviar mensagem para funcionarios antendentes");
    ...
    private void btEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEnviarActionPerformed
        ArrayList<FuncionarioAtendente> funcionarios = this.clinica.getFuncionariosAtendentes();
        ...
        for(FuncionarioAtendente f: funcionarios){
