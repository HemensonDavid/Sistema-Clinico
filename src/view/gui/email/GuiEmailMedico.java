...
public class GuiEmailMedico extends javax.swing.JFrame {
    
    private Clinica clinica;
    private ClinicaMail cm;

    public GuiEmailMedico(Clinica clinica) {
    ...
    private void initComponents() {
        ...
        setTitle("Enviar mensagem para médicos");
    ...
    private void btEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEnviarActionPerformed
        ...
        for(Medico m: medicos){
            if(!(this.cm.enviarEmail(mensagem, m.getEmail(), assunto))){
                algumErro = true;
                nomesDasPessoasComErroNoEnvio += (m.getNome() + "\n");
            }
        }
