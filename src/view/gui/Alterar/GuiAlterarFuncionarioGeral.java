...
public class GuiAlterarFuncionarioGeral extends javax.swing.JFrame {

    private FuncionarioGeral funcionarioGeral;
    
    public GuiAlterarFuncionarioGeral(FuncionarioGeral funcionarioGeral) {
        initComponents();
        this.funcionarioGeral = funcionarioGeral;
                
        this.tfNome.setText(funcionarioGeral.getNome());
        this.ftfNascimento.setText(funcionarioGeral.getNascimento().getDataAnual());
        this.ftfCPF.setText(funcionarioGeral.getCpf());
        this.tfRG.setText(funcionarioGeral.getRg());
        this.ftfTelefone.setText(funcionarioGeral.getTelefone());
        this.tfEmail.setText(funcionarioGeral.getEmail());
        this.tfPais.setText(funcionarioGeral.getEndereco().getPais());
        this.tfCidade.setText(funcionarioGeral.getEndereco().getCidade());
        this.tfRua.setText(funcionarioGeral.getEndereco().getRua());
        this.tfNumero.setText(funcionarioGeral.getEndereco().getNumero());
        this.tfBairro.setText(funcionarioGeral.getEndereco().getBairro());
        this.tfReferencia.setText(funcionarioGeral.getEndereco().getReferencia());
        this.tfFuncao.setText(funcionarioGeral.getFuncao());
        this.tfSalario.setText(String.valueOf(funcionarioGeral.getSalario()));
    ...
    private void initComponents() {
        ...
        pnInfoTrabalhistasLayout.setHorizontalGroup(
            ...
            .addGroup(pnInfoTrabalhistasLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tfSalario, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAlterarActionPerformed
        ...
        this.funcionarioGeral.setNome(nome);
        this.funcionarioGeral.setNascimento(dataNascimento);
        this.funcionarioGeral.setCpf(cpf);
        this.funcionarioGeral.setRg(rg);
        this.funcionarioGeral.setTelefone(telefone);
        this.funcionarioGeral.setEmail(email);
        this.funcionarioGeral.setEndereco(endereco);
        this.funcionarioGeral.setFuncao(funcao);
        this.funcionarioGeral.setSalario(salarioReal);
