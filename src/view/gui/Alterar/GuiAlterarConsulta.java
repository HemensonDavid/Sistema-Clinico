...
public class GuiAlterarConsulta extends javax.swing.JFrame {
    
    private Clinica clinica;
    private Consulta consulta;
            
    public GuiAlterarConsulta(Clinica clinica,Consulta consulta) {
	...
	setLocation((tela.width - getSize().width) / 2, (tela.height - getSize().height) / 2);
        ...
        this.cbListaDePacientes.setSelectedItem(consulta.getPaciente());
        this.taSintomas.setText(consulta.getSintoma());
        this.cbListaDeMedicos.setSelectedItem(consulta.getMedico());
        this.ffDataDaConsulta.setText(consulta.getData().getDataAnual());
        this.ffHorarioDaConsulta.setText(consulta.getData().getHorario());
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(43, 43, 43)
                        .addComponent(btAlterar, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAlterarActionPerformed
        ...
        if(!(this.clinica.dataDeConsultaExistente(data))){
            ...
            this.consulta.setSintoma(sintoma);
                              
            String mensagem = this.clinica.getMensagemDeConsulta(consulta);
            this.clinica.getEmail().enviarEmail(mensagem, consulta.getPaciente().getEmail(), "Consulta alterada");
            
            JOptionPane.showMessageDialog(null, "Consulta alterada com sucesso!\n" + "Uma mensagem com informações sobre o novo agendamento foi enviada para: " + consulta.getPaciente().getEmail());
