...
public class GuiCadastroPaciente extends javax.swing.JFrame {
    ...
    public GuiCadastroPaciente(Clinica clinica) {
    ...
    private void initComponents() {
        ...
        ffTelefone.setText("");
        ffTelefone.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ffTelefoneActionPerformed(evt);
            }
        });
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        String convenio = tfConvenio.getText();
        String observacoes = taObservacoes.getText();
        String nascimento = this.ffNascimento.getText();
        ...
        boolean camposPreenchidos = nome.equals("") || nascimento.equals("  /  /    ") || cpf.equals("   .   .   -  ") || rg.equals("")
                ...
                || bairro.equals("") || referencia.equals("")|| convenio.equals("") || observacoes.equals("");
        
        if(camposPreenchidos == false){
            Data dataNasc = Data.parseData(nascimento);
            ...
            Paciente paciente = new Paciente(nome, rg, cpf, telefone, email, endereco, dataNasc, fichaClinica);
            
            System.out.println(paciente);
            
            this.clinica.addPessoa(paciente);
    ...
    private void ffTelefoneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ffTelefoneActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ffTelefoneActionPerformed
