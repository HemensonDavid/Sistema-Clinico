...
import static model.GeradorDeID.gerarID;
...
public class GuiCadastroMedico extends javax.swing.JFrame {
    ...
    public GuiCadastroMedico(Clinica clinica) {
    ...
    ArrayList<String> especializacoes;
    ArrayList<String> telefonesEmergenciais;
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        boolean camposPreenchidos = nome.equals("") || cpf.equals("   .   .   -  ") || rg.equals("") || telefone.equals("(  )     -    ") || email.equals("") || pais.equals("")
            || cidade.equals("") || rua.equals("") || numero.equals("") || bairro.equals("") || referencia.equals("") || nasc.equals("  /  /    ") 
            || nasc.equals("") || horarioDeConsulta.equals("") || valorDaConsulta.equals("") || salario.equals("");
        ...
        if(camposPreenchidos == false){
            ...
            Medico medico = new Medico(crm, nome, rg, cpf, email, telefone, endereco, dataNasc, id ,salarioReal, valorRealDaConsulta, especializacoes, telefonesEmergenciais, convenios);

            System.out.println(medico);

            this.clinica.addPessoa(medico);
