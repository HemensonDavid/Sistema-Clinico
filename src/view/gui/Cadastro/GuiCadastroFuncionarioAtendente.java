...
public class GuiCadastroFuncionarioAtendente extends javax.swing.JFrame {

    private Clinica clinica;
    
    public GuiCadastroFuncionarioAtendente(Clinica clinica) {
        initComponents();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(pnFormacaoAcademica, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(pnInfoTrabalhistas, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap(25, Short.MAX_VALUE))
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        String conclusao = tfConclusaoCurso.getText();
        String tcc = tfTCC.getText();
        String salario = tfSalario.getText();

        boolean camposPreenchidos = nome.equals("") || rg.equals("") || email.equals("") || cpf.equals("   .   .   -  ") || rg.equals("") || telefone.equals("(   )         ") || email.equals("") || pais.equals("") || estado.equals("")
                || cidade.equals("") || rua.equals("") || numero.equals("") || bairro.equals("") || referencia.equals("") || 
                nascimento.equals("  /  /    ") || faculdade.equals("") || conclusao.equals("") || tcc.equals("") || salario.equals("");
        ...
        if(camposPreenchidos == false){
            ...
            FuncionarioAtendente funcionarioAtendente = new FuncionarioAtendente(nome, rg, cpf, email, telefone, endereco, dataNascimento, "34556", salarioReal, conclusao, faculdade, tcc);
            
            this.clinica.addPessoa(funcionarioAtendente);
